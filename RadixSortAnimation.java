...
public class RadixSortAnimation extends JFrame {
	...
	//pass 2 nums
	private JLabel num1pass2;
	private JLabel num2pass2;
	private JLabel num3pass2;
	private JLabel num4pass2;
	private JLabel num5pass2;
	
	//pass 3 nums
	private JLabel num1pass3;
	private JLabel num2pass3;
	private JLabel num3pass3;
	private JLabel num4pass3;
	private JLabel num5pass3;
	...
	public RadixSortAnimation() {
        ...
        JLabel num1pass3 = new JLabel("135");
        ...
        JLabel num2pass3 = new JLabel("221");
        ...
        JLabel num3pass3 = new JLabel("467");
        ...
        JLabel num4pass3 = new JLabel("703");
        ...
        JLabel num5pass3 = new JLabel("888");
         ...
         // PASS 1
                 ...
                 if (timer1 == null || !timer1.isRunning()) {
                     ...
                     if (userInput[0].charAt(2) == '0') {
                    	    ...
                    	    desiredY = 140;
                    	} else if (userInput[0].charAt(2) == '2') {
                    	    desiredY = 176;
                    	} else if (userInput[0].charAt(2) == '3') {
                    	    desiredY = 212;
                    	} else if (userInput[0].charAt(2) == '4') {
                    	    desiredY = 248;
                    	} else if (userInput[0].charAt(2) == '5') {
                    	    desiredY = 284;
                    	} else if (userInput[0].charAt(2) == '6') {
                    	    desiredY = 320;
                    	} else if (userInput[0].charAt(2) == '7') {
                    	    desiredY = 356;
                    	} else if (userInput[0].charAt(2) == '8') {
                    	    desiredY = 392;
                    	} else if (userInput[0].charAt(2) == '9') {
                    	    desiredY = 428;
                    	} else {
                ...
                if (timer2 == null || !timer2.isRunning()) {
                    ...
                    if (userInput[1].charAt(2) == '0') {
                	    desiredY = 104;
                	} else if (userInput[1].charAt(2) == '1') {
                	    desiredY = 140;
                	} else if (userInput[1].charAt(2) == '2') {
                	    desiredY = 176;
                	} else if (userInput[1].charAt(2) == '3') {
                	    desiredY = 212;
                	} else if (userInput[1].charAt(2) == '4') {
                	    desiredY = 248;
                	} else if (userInput[1].charAt(2) == '5') {
                	    desiredY = 284;
                	} else if (userInput[1].charAt(2) == '6') {
                	    desiredY = 320;
                	} else if (userInput[1].charAt(2) == '7') {
                	    desiredY = 356;
                	} else if (userInput[1].charAt(2) == '8') {
                	    desiredY = 392;
                	} else if (userInput[1].charAt(2) == '9') {
                	    desiredY = 428;
                	} else {
                	    // handle invalid input
                	    desiredY = 0; // assign a default value
                ...
                if (timer3 == null || !timer3.isRunning()) {
                    ...
                    if (userInput[2].charAt(2) == '0') {
                	    desiredY = 104;
                	} else if (userInput[2].charAt(2) == '1') {
                	    desiredY = 140;
                	} else if (userInput[2].charAt(2) == '2') {
                	    desiredY = 176;
                	} else if (userInput[2].charAt(2) == '3') {
                	    desiredY = 212;
                	} else if (userInput[2].charAt(2) == '4') {
                	    desiredY = 248;
                	} else if (userInput[2].charAt(2) == '5') {
                	    desiredY = 284;
                	} else if (userInput[2].charAt(2) == '6') {
                	    desiredY = 320;
                	} else if (userInput[2].charAt(2) == '7') {
                	    desiredY = 356;
                	} else if (userInput[2].charAt(2) == '8') {
                	    desiredY = 392;
                	} else if (userInput[2].charAt(2) == '9') {
                	    desiredY = 428;
                	} else {
                	    // handle invalid input
                	    desiredY = 0; // assign a default value
                ...
                if (timer4 == null || !timer4.isRunning()) {
                    ...
                    if (userInput[3].charAt(2) == '0') {
                	    desiredY = 104;
                	} else if (userInput[3].charAt(2) == '1') {
                	    desiredY = 140;
                	} else if (userInput[3].charAt(2) == '2') {
                	    desiredY = 176;
                	} else if (userInput[3].charAt(2) == '3') {
                	    desiredY = 212;
                	} else if (userInput[3].charAt(2) == '4') {
                	    desiredY = 248;
                	} else if (userInput[3].charAt(2) == '5') {
                	    desiredY = 284;
                	} else if (userInput[3].charAt(2) == '6') {
                	    desiredY = 320;
                	} else if (userInput[3].charAt(2) == '7') {
                	    desiredY = 356;
                	} else if (userInput[3].charAt(2) == '8') {
                	    desiredY = 392;
                	} else if (userInput[3].charAt(2) == '9') {
                	    desiredY = 428;
                	} else {
                	    // handle invalid input
                	    desiredY = 0; // assign a default value
                ...
                if (timer5 == null || !timer5.isRunning()) {
                    ...
                    if (userInput[4].charAt(2) == '0') {
                	    desiredY = 104;
                	} else if (userInput[4].charAt(2) == '1') {
                	    desiredY = 140;
                	} else if (userInput[4].charAt(2) == '2') {
                	    desiredY = 176;
                	} else if (userInput[4].charAt(2) == '3') {
                	    desiredY = 212;
                	} else if (userInput[4].charAt(2) == '4') {
                	    desiredY = 248;
                	} else if (userInput[4].charAt(2) == '5') {
                	    desiredY = 284;
                	} else if (userInput[4].charAt(2) == '6') {
                	    desiredY = 320;
                	} else if (userInput[4].charAt(2) == '7') {
                	    desiredY = 356;
                	} else if (userInput[4].charAt(2) == '8') {
                	    desiredY = 392;
                	} else if (userInput[4].charAt(2) == '9') {
                	    desiredY = 428;
                	} else {
                	    // handle invalid input
                	    desiredY = 0; // assign a default value
                ...
                newLabel6.setBounds(num1pass2.getX(), num1pass2.getY(), 
                		num1pass2.getWidth(), num1pass2.getHeight());
                ...
                newLabel7.setBounds(num2pass2.getX(), num2pass2.getY(), 
                		num2pass2.getWidth(), num2pass2.getHeight());
                ...
                newLabel8.setBounds(num3pass2.getX(), num3pass2.getY(), 
                		num3pass2.getWidth(), num3pass2.getHeight());
                ...
                newLabel9.setBounds(num4pass2.getX(), num4pass2.getY(), 
                		num4pass2.getWidth(), num4pass2.getHeight());
                ...
                newLabel10.setBounds(num5pass2.getX(), num5pass2.getY(), 
                		num5pass2.getWidth(), num5pass2.getHeight());
                ...
                newLabel11.setBounds(num1pass3.getX(), num1pass3.getY(), 
                		num1pass3.getWidth(), num1pass3.getHeight());
                ...
                newLabel12.setBounds(num2pass3.getX(), num2pass3.getY(), 
                		num2pass3.getWidth(), num2pass3.getHeight());
                ...
                newLabel13.setBounds(num3pass3.getX(), num3pass3.getY(), 
                		num3pass3.getWidth(), num3pass3.getHeight());
                ...
                newLabel14.setBounds(num4pass3.getX(), num4pass3.getY(), 
                		num4pass3.getWidth(), num4pass3.getHeight());
                ...
                newLabel15.setBounds(num5pass3.getX(), num5pass3.getY(), 
                		num5pass3.getWidth(), num5pass3.getHeight());
